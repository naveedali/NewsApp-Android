...
import sample.naveedali.newsapp.BuildConfig
import sample.naveedali.newsapp.data.remote.NewsApiConfig
import sample.naveedali.newsapp.data.remote.NewsApiService
import sample.naveedali.newsapp.di.qualifier.NewsApiKey
import javax.inject.Singleton

/** Provides the whole networking stack: JSON config, OkHttp client, Retrofit, API service. */
@Module
